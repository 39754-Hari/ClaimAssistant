module.exports = {
    'en-US': {
        'translation': {
            'HELLO_MESSAGE': '<s>Hi</s><s>Welcome to the policy assistant.</s><s>What can I do for you.</s>',
            ...
            'CLAIM_ID_NEEDED': '<s>Can you please provide the claim number.</s>',
            'INVALID_CLAIM_ID': '<s>Can you please provide the claim number.</s>'
        }
    },
    'de-DE': {
        'translation': {
            ...
            'CLAIM_ID_NEEDED': '<s>Können Sie bitte die Anspruchs-ID angeben?.</s>',
            'INVALID_CLAIM_ID': '<s>Können Sie bitte die Anspruchs-ID angeben?.</s>'
        }
    }
};